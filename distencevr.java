...
import javax.swing.*;
import java.util.*;
public class distencevr extends JFrame
{
 String source="";
 Container con;
 JScrollPane jsp;
 ...
 int ashokcost=0;
 Image ii;
 public distencevr(String psource)
 {
  source=psource;
  setTitle("Distence Vector->Source :"+psource);
  con=getContentPane();
  d1=tk.getScreenSize(); 
  setSize(400,500);
  d2=getSize();
 ...
 public double getDistenceVectorEfficiancy(Packet p)
 {
 ...
 public double getDistenceVectorDelay()
 {
   link l=new link();
   double delay=0;
